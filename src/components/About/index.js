      ...
      <div className="about-page container">
        <div className="text-container-about">
          ...
          <p>
            ...
            started cooking, I come from a large family and loved to cook. And
            although I would go on to work as a chef for 17 years, I also had my
            first real experience with computers at the age of 18. My friend
            from school helped me build a custom PC for my dad. It became the
            household PC and that is when I really got into computers. If I
            wasn't out skateboarding on my day off work, I was messing around
            with the computer. Either playing music, playing games or even
            modding them. I was always resourceful at solving my computer needs
            either by finding information online or at the library. If I
            couldn't find a way, I would troubleshoot through trial and error.
            Editing code and adding mods to games and applications bacame a 2nd
            hobby along with the dozen computers I had built and repaired over
            the following years.
          </p>
          <p>
